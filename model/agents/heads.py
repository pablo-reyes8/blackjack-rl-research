...
class QHead(nn.Module):
    def __init__(self, *, input_dim: int, hidden_dim: int, output_dim: int, activation: str, dropout: float) -> None:
        super().__init__()
...
class DuelingQHead(nn.Module):
    def __init__(
        ...
        *,
        ...
        advantage_layers.append(nn.Linear(advantage_hidden_dim, output_dim))
